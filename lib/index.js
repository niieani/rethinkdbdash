...
function main(options) {
  var configureTcpPolyfill = require('./websocket-support/net.js').configureTcpPolyfill;
  configureTcpPolyfill({path: options.path, secure: options.secure, wsProtocols: options.wsProtocols, simulatedLatencyMs: options.simulatedLatencyMs});
